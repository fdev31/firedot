...
from testconfig import GENERATED_OUTPUT_DIR as OUTPUT_DIR, getOpt
...
source_images = [
    ...
    if file.startswith("ref") and file.endswith(".png")
]
...
for source_image in source_images:
    ...
    output_image_path = os.path.join(
        OUTPUT_DIR, source_image.replace(".png", "_output.png")
    )
    print(f"Generating {output_image_path}")

    # Call the function to generate halftone image
    create_halftone(input_image_path, output_image_path, **getOpt(source_image))
